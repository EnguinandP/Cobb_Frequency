                  ...
                  CApp
                    {
                      appf =
                        {
                          x = VVar (replace_bool_gen_string "bool_gen"#:ty);
                          ty = ty2;
                        };
                                      ...
                                      VLam
                                        {
                                          ...
                                          body =
                                            (if
                                               not
                                                 (has_recursive_call exp1 name)
                                             then replace_bool_gen exp1 name arg
                                             else replace_bool_gen exp2 name arg);
                                        };
                                    ty = Nt.Ty_any;
                                  };
                              };
                      ...
                      body =
                        {
                          x =
                            CLetE
                              {
                                (* let (recursive_case) = base_case exp *)
                                lhs = "recursive_case"#:ty;
                                rhs =
                                  {
                                    x =
                                                ...
                                                VLam
                                                  {
                                                    ...
                                                    body =
                                                      (if
                                                         has_recursive_call exp1
                                                           name
                                                       then
                                                         replace_bool_gen exp1
                                                           name arg
                                                       else
                                                         replace_bool_gen exp2
                                                           name arg);
                                                  };
                                              ty = Nt.Ty_any;
                                            };
                  ...
                  CLetE
                    {
                      ...
                      rhs =
                        {
                          x =
                            CApp
                              {
                                appf =
                                  { x = VVar "fst_case"#:ty; ty = Nt.Ty_any };
                                apparg =
                                  {
                                    x =
                                      VLam
                      ...
                      body =
                        {
                          x = CVal { x = VVar "snd_case"#:ty; ty = Nt.Ty_any };
                          ty = Nt.Ty_any;
                        };
                    };
                ty = Nt.Ty_any;
